# Generated by Powerlevel10k configuration wizard on 2021-05-23 at 11:30 +07.
...
function prompt_ethernet(){
  integer eth_speed="$(cat /sys/class/net/enp2s0/speed)"
  p10k segment -s HOT  -f blue    -t "${eth_speed}Mbs" -i $''
}
